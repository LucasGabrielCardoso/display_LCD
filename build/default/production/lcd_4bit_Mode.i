...
# 34 "./system_config.h" 2
# 9 "lcd_4bit_Mode.c" 2

# 1 "./device_config.h" 1
# 10 "lcd_4bit_Mode.c" 2
# 74 "lcd_4bit_Mode.c"
void LCD_Set_Port(unsigned char instruction)
{
    LATCbits.LATC7 = (0x80==(instruction&0x80));
    LATCbits.LATC6 = (0x40==(instruction&0x40));
    LATCbits.LATC5 = (0x20==(instruction&0x20));
    LATCbits.LATC4 = (0x10==(instruction&0x10));
}
...
void LCD_Instruction(unsigned char instruction)
{
    ...
    do{LATCbits.LATC7 = (0x80==(instruction&0x80)); LATCbits.LATC6 = (0x40==(instruction&0x40)); LATCbits.LATC5 = (0x20==(instruction&0x20)); LATCbits.LATC4 = (0x10==(instruction&0x10));}while(0);
...
void putch(char data)
{
    ...
    do{LATCbits.LATC7 = (0x80==(data&0x80)); LATCbits.LATC6 = (0x40==(data&0x40)); LATCbits.LATC5 = (0x20==(data&0x20)); LATCbits.LATC4 = (0x10==(data&0x10));}while(0);
...
void LCD_Set_New_Simbol(unsigned char *simbol, unsigned char simbol_address)
{
    LCD_Instruction(0x40|simbol_address);
...
void LCD_Initializer()
{
    ...
    LATDbits.LATD3 = 1;
    do{LATCbits.LATC7 = (0x80==(0x30&0x80)); LATCbits.LATC6 = (0x40==(0x30&0x40)); LATCbits.LATC5 = (0x20==(0x30&0x20)); LATCbits.LATC4 = (0x10==(0x30&0x10));}while(0);
    LATDbits.LATD3 = 0;
    _delay((unsigned long)((45)*(8000000/4000000.0)));
    ...
    LATDbits.LATD3 = 1;
    do{LATCbits.LATC7 = (0x80==(0x20&0x80)); LATCbits.LATC6 = (0x40==(0x20&0x40)); LATCbits.LATC5 = (0x20==(0x20&0x20)); LATCbits.LATC4 = (0x10==(0x20&0x10));}while(0);
    LATDbits.LATD3 = 0;
    _delay((unsigned long)((45)*(8000000/4000000.0)));

    LCD_Instruction(0x20|0x28);
